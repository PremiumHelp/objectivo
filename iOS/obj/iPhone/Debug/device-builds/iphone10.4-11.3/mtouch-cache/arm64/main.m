...
extern void *mono_aot_module_ObjectivoF_iOS_info;
...
extern void *mono_aot_module_ObjectivoF_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_System_Xml_Linq_info;
extern void *mono_aot_module_Microsoft_ProjectOxford_Vision_info;
...
{
	mono_aot_register_module (mono_aot_module_ObjectivoF_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_ObjectivoF_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_System_Xml_Linq_info);
	mono_aot_register_module (mono_aot_module_Microsoft_ProjectOxford_Vision_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "ObjectivoF.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
